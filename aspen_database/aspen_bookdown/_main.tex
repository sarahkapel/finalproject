...
\hypersetup{
  pdftitle={Creating a Database for Aspen Seedlings},
  pdfauthor={Sarah Kapel},
  hidelinks,
  pdfcreator={LaTeX via pandoc}}

\title{Creating a Database for Aspen Seedlings}
\author{Sarah Kapel}
\date{2023-03-17}
...
\begin{figure}
\centering
\includegraphics{database_structure.png}
...
This is the code we used to create the database. We'll start with loading the \texttt{DBI} and \texttt{RSQLite} packages:
...
\hypertarget{creating-the-measurments-table}{%
\subsection{Creating the measurments table}\label{creating-the-measurments-table}}
...
\hypertarget{creating-the-other-tables}{%
\subsection{Creating the other tables}\label{creating-the-other-tables}}

Since creating the first table, I quickly replicated this process for the remaining tables.

\begin{Shaded}
\begin{Highlighting}[]
\CommentTok{\# Create planting\_data table }

\FunctionTok{dbExecute}\NormalTok{(aspen\_db, }\StringTok{"CREATE TABLE planting\_data (}
\StringTok{tag\_id varchar(4) NOT NULL,}
\StringTok{photo\_no varchar (6), }
\StringTok{planter varchar (3), }
\StringTok{recorder varchar (10), }
\StringTok{azimuth varchar (5),}
\StringTok{dist varchar (5), }
\StringTok{log\_ht varchar (5), }
\StringTok{comp\_sp varchar (5), }
\StringTok{comp\_dist varchar (5), }
\StringTok{comp\_ht varchar (5), }
\StringTok{grass varchar (4), }
\StringTok{forb varchar (4), }
\StringTok{rock varchar (4), }
\StringTok{shrub varchar (4), }
\StringTok{cwd varchar (4),}
\StringTok{litter varchar (4), }
\StringTok{bare\_soil varchar (4), }
\StringTok{moss varchar (4), }
\StringTok{snag varchar (4), }
\StringTok{other varchar (4), }
\StringTok{total varchar (3), }
\StringTok{PRIMARY KEY (tag\_id)}
\StringTok{);"}\NormalTok{)}

\NormalTok{planting\_data }\OtherTok{\textless{}{-}} \FunctionTok{read.csv}\NormalTok{(}\StringTok{"planting\_data.csv"}\NormalTok{,}\AttributeTok{stringsAsFactors =} \ConstantTok{FALSE}\NormalTok{)}

\FunctionTok{dbWriteTable}\NormalTok{(aspen\_db, }\StringTok{"plantind\_data"}\NormalTok{, planting\_data, }\AttributeTok{append =} \ConstantTok{TRUE}\NormalTok{)}

\DocumentationTok{\#\# Create sites table }
...
\DocumentationTok{\#\# Create soil\_moisture table }
...
\DocumentationTok{\#\# Create structures table }
...
\StringTok{PRIMARY KEY (structure\_no)}
\StringTok{);"}\NormalTok{)}
