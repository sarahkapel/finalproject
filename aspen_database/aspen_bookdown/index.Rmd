...
description: |
  For this week's assignment in Reproducible Science 2023, I have created a 
  bookdown. This explains the process I used to create aspen seedling database 
  for my planting project. 
link-citations: yes
...
![Fig. 1: Diagram of database structure](database_structure.png)
